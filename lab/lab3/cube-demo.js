...
function puttextures(){
    for (var skyboxStep = 0; skyboxStep < 6; skyboxStep++) {
        ...
        if (skyboxStep == 0)
            loadimagetocanvas(canvasTex, "poop");
        else if (skyboxStep == 1)
            loadimagetocanvas(canvasTex, "poop1");
        else if (skyboxStep == 2)
            loadimagetocanvas(canvasTex, "cat");
        else if (skyboxStep == 3)
            loadimagetocanvas(canvasTex, "poop1");
        else if (skyboxStep == 4)
            loadimagetocanvas(canvasTex, "cat");
        else if (skyboxStep == 5)
            loadimagetocanvas(canvasTex, "cat");
...
function loadimagetocanvas(canvas, imgid) {
